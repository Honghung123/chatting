import { callRenewTokenRequest } from "@/apis/auth-api";
...
// Specify the base URL for API requests and treat all responses as valid to avoid revoking the console.error function automatically
