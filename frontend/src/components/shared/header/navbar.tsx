    ...
    return (
        <div className="fixed z-50 grid h-14 w-full grid-cols-7 gap-4 bg-white shadow-sm dark:bg-[#242526] px-4">
            ...
            <div className="col-span-3 flex items-center justify-center space-x-2">
                <Link href="/" id="home">
                    <div className="flex h-12 w-24 cursor-pointer items-center justify-center rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700">
                        <div className="relative flex h-auto w-14 items-center justify-center">
                            <div className={`${pathName === "/" || undefined ? "text-primary" : "text-gray-400"}`}>
                                <svg
                                    viewBox="0 0 24 24"
                                    width="24"
                                    height="24"
                ...
                {/* <Tooltip place="bottom" anchorSelect="#marketplace" content="Marketplace" /> */}
                <Link href="/groups" id="groups">
                    <div className="flex h-12 w-24 cursor-pointer items-center justify-center rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700">
                        <div className="relative flex h-auto w-14 items-center justify-center">
                            <div className={`${pathName === "/groups" ? "text-primary" : "text-gray-400"}`}>
                                <svg
                                    viewBox="0 0 24 24"
                                    width="24"
                                    height="24"
                ...
                <Link href="/gaming" id="gaming">
                    <div className="flex h-12 w-24 cursor-pointer items-center justify-center rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700">
                        <div className="relative flex h-auto w-14 items-center justify-center">
                            <div className={`${pathName === "/gaming" ? "text-primary" : "text-gray-400"}`}>
                                <svg
                                    viewBox="0 0 24 24"
                                    width="24"
                                    height="24"
