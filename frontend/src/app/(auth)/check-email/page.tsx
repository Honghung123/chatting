        ...
        <>
            <div className="rounded-xl w-[330px] sm:min-w-[420px] relative p-[3px] overflow-hidden">
                ...
                <div className="bg-white dark:bg-gray-800 relative z-10 rounded-lg p-4">
                    <p className="text-5xl font-bold text-center dynamic-text pb-2">Verify account</p>
                    <p className="text-xl font-bold text-center pb-2">Please check your email to verify your account</p>
                    ...
                    <div className="flex justify-center gap-2">
                        <p className="text-center">Already have an another account?</p>
