                ...
                <div className="grid grid-cols-5 gap-2">
                    <div className="col-span-2 flex flex-col gap-4">
                        <div className="flex flex-col gap-4 rounded-lg bg-white p-3 text-gray-600 shadow dark:bg-neutral-800 dark:text-gray-300">
                            <p className="text-xl font-bold text-gray-800 dark:text-gray-300">Intro</p>
                        ...
                        <div className="flex flex-col gap-4 rounded-lg bg-white p-3 text-gray-600 shadow dark:bg-neutral-800">
                            <div className="flex items-center justify-between">
                                <p className="text-xl font-bold text-gray-800 dark:text-gray-300">Photos</p>
                                <a className="cursor-pointer text-sm text-primary hover:underline">See all photos</a>
                            </div>
                        ...
                        <div className="flex flex-col gap-4 rounded-lg bg-white p-3 shadow dark:bg-neutral-800">
                            <div className="flex justify-between">
                                <div>
                                    <p className="text-xl font-bold text-gray-800 dark:text-gray-300">Friends</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-300">528 friends</p>
                                </div>
                                <a className="cursor-pointer text-sm text-primary hover:underline">See all friends</a>
                            </div>
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    />
                                    <p className="mt-2 text-sm text-black dark:text-gray-200">Friend 4</p>
                                </div>
                                <div>
                                    <img
                                        className="w-full rounded-md"
                                    ...
                                    />
                                    <p className="mt-2 text-sm text-black dark:text-gray-200">Friend 5</p>
                                </div>
                                <div>
                                    <img
                                        className="w-full rounded-md"
                                    ...
                                    />
                                    <p className="mt-2 text-sm text-black dark:text-gray-200">Friend 6</p>
                                </div>
                                <div>
                                    <img
                                        className="w-full rounded-md"
                                    ...
                                    />
                                    <p className="mt-2 text-sm text-black dark:text-gray-200">Friend 7</p>
                                </div>
                                <div>
                                    <img
                                        className="w-full rounded-md"
                                    ...
                                    />
                                    <p className="mt-2 text-sm text-black dark:text-gray-200">Friend 8</p>
                                </div>
                            </div>
                        </div>
                    </div>
